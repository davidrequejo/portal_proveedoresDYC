...
Route::get('limpiar-cookies', [InicioController::class, 'limpiarCookies'])->name('inicio.limpiar_cookies');
Route::get('limpiar-cache', [InicioController::class, 'limpiarCache'])->name('inicio.limpiar_cache_sistema');
