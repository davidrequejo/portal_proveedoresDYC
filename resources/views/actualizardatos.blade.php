...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed">
  ...
  <script src="{{ asset('assets/js/actualizardatosproveedor.js') }}?version_erp=01.02"></script>
  <script src="{{ asset('assets/js/persona_cuentabancaria.js') }}?version_erp=01.02"></script>
