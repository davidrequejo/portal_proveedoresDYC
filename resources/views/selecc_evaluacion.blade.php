...
<head>
  ...
  <title>Usuarios | Portal Proveedores D&C</title>
      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">Selección Evaluación Proveedor</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
                <div class="float-right">

                  <div class="btn-group btn-agregar-usuario">
                    <button type="button" class="btn btn-primary" style="border-color: #2e6da4 !important;" data-toggle="modal" data-target="#modal-agregar-usuario" onclick="limpiar_form_proyecto();" ><i class="ti ti-users-plus"></i> Crear nuevo</button>
        ...
        <section class="content">
          <div class="container-fluid">
            ...
            <div class="row">
              ...
              <!-- ./col -->
              <div class="col" id="div-tabla-principal-usuario">
                <div class="card">
                  ...
                  <div class="card-body pb-1">
                    ...
                    <div class="table-responsive">
                      ...
                      <table class="table table-bordered table-hover styletabla" id="tabla-usuarios">
                        <thead>
                          <tr>                        
                            <th>Acciones</th>
                            <th data-sort="codigo" class="sortable">Código</th>
                            <th data-sort="nombre_razonsocial" class="sortable">Usuario</th>
                            <th data-sort="tipo_entidad_sunat" class="sortable">Nombres </th>
                            <th data-sort="abreviatura" class="sortable">Tipo Documento</th>
                            <th data-sort="celular" class="sortable">Nro Documento</th>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
              <div class="modal-content">
                <div class="modal-header py-2 bg-color-principal">
                  <h4 class="modal-title text-white">Usuarios</h4>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span class="text-danger" aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body">
                  <form id="form-agregar-usuario" name="form-agregar-usuario" method="POST">
                    @csrf
                ...
                <div class="modal-footer justify-content-between py-1">
                  ...
                  <button type="button" class="btn btn-primary" id="guardar_registro_usuario" ><i class="ti ti-device-floppy"></i> Guardar</button>
                </div>
              </div>
              <!-- /.modal-content -->
            </div>
