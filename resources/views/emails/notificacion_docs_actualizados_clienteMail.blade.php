                ...
                <tr>
                    <td style="background-color:#231f20;padding:25px 30px;color:#ffffff;" align="center">
                        ...
                        <h2 style="margin:0;font-size:22px;font-weight:bold;">
                            ¡Documentos Actualizados en el portal de Homologación!
                        </h2>
                ...
                <tr>
                    <td style="padding:30px;">
                        ...
                        <p style="line-height:1.5;">
                            Se registró una actualización de los documentos en el portal de homologación puedes acceder a verificar con el siguiente detalle:
                        </p>
