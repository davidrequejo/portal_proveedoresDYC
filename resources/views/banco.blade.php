...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed">
    ...
    @if (auth()->user()->perm_bancos)
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class="modal fade" id="modal-agregar-banco">
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="form-agregar-banco" name="form-agregar-banco" method="POST">
                    @csrf
                    ...
                    <!-- /.card-body -->
                    <button type="submit" style="display: none;" id="submit-form-banco">Submit</button>
                  </form>
                </div>
                <div class="modal-footer justify-content-between py-1">
                  ...
                  <button type="button" class="btn btn-success" id="guardar_registro_banco" ><i class="ti ti-device-floppy"></i> Guardar</button>
                </div>
              </div>
              <!-- /.modal-content -->
            </div>
  ...
  <script src="{{ asset('assets/js/banco.js') }}?version_erp=01.12"></script>
