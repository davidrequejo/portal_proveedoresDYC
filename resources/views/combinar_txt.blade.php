...
<head>
  ...
  <title>Combinar TXT | ERP Optimiza 360</title>
...
<body class="hold-transition sidebar-mini sidebar-collapse layout-fixed">
                    ...
                    <div class="card-body">
                      <div class="tab-content" id="custom-tabs-tabContent">
                        <div class="tab-pane fade show active" id="custom-tabs-resumen" role="tabpanel" aria-labelledby="custom-tabs-resumen-tab">
                          ...
                          <button onclick="descargar_combinado('txt')" class="btn btn-success"><i class="ti ti-download"></i> Descargar TXT</button>
            ...
            <div class="modal-dialog modal-lg modal-dialog-scrollable">
              <div class="modal-content">
                <div class="modal-header py-2">
                  <h4 class="modal-title">Combinar TXT</h4>
                    ...
                    <div class="row" id="cargando-1-formulario">  
                      ...
                      <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="form-group">
                          <label for="archivo_txt">Archivo </label>                              
                          <button type="button" id="btn-excel-eliminar" class="btn btn-sm btn-outline-danger"><i class="ti ti-trash-x"></i> Eliminar</button>
                          <input type="file" name="archivo_txt[]" id="archivo_txt" class="form-control" multiple  required>                    
                        </div>
  ...
  <script src="{{ asset('assets/js/combinar_txt.js') }}?version_erp=01.02"></script>
