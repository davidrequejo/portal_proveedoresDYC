  ...
  <link rel="stylesheet" href="{{ asset('assets/icon-fonts/RemixIcons/remixicon.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/icon-fonts/feather/feather.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/icon-fonts/bootstrap-icons/font/bootstrap-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/icon-fonts/tabler-icons/webfont/tabler-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/icon-fonts/line-awesome/1.3.0/css/line-awesome.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/icon-fonts/boxicons/fonts/basic/boxicons.css') }}">
...
<link rel="stylesheet" href="{{ asset('adminlte3/plugins/pace-progress/themes/black/pace-theme-flat-top.css') }}">
  ...
  <!-- DataTables -->  
  {{-- <link rel="stylesheet" type="text/css" href="{{ asset('adminlte3/plugins/datatables2/jquery.dataTables.min.css') }}">    
  <link rel="stylesheet" type="text/css" href="{{ asset('adminlte3/plugins/datatables2/buttons.dataTables.min.css') }}" rel="stylesheet"/>
  <link rel="stylesheet" type="text/css" href="{{ asset('adminlte3/plugins/datatables2/responsive.dataTables.min.css') }}" rel="stylesheet"/> --}}
