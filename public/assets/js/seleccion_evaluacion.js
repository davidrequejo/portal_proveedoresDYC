...
lista_select2(`${BASE_URL}/select2/personas_selec_evaluacion`, '#idpersona');

$("#idpersona").select2({ theme: "bootstrap4", placeholder: "Seleccionar Proveedor", allowClear: true, });
