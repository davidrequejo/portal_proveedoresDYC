...
function ver_editar_cliente(idpersona) {
  ...
  $.getJSON(`${BASE_URL}/cliente/${idpersona}/mostrar_cliente`, function (e) {
    ...
    if (e.status == true) {
      ...
      $("#tipo_documento").val(e.data.cliente.tipo_documento).trigger('change');
      $("#numero_documento").val(e.data.cliente.numero_documento);
      $("#nombre_razonsocial").val(e.data.cliente.nombre_razonsocial);
...
function guardar_y_editar_cliente(e) {
  ...
  if (id == '') {
    url_editar_crear =  `${BASE_URL}/cliente/crear_cliente` ;    
  } else {
    url_editar_crear = `${BASE_URL}/cliente/editar_cliente/${id}`;
...
function eliminar_cliente(id, nombres) {
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      $.ajax({
        url: `${BASE_URL}/cliente/eliminar_cliente/${id}`,
        type: "PUT",
        data: {
...
$("#opcion-p-editar").on("click", function (e) {
  e.preventDefault();
  if (idpersona_select) {
    ver_editar_cliente(idpersona_select);
  }
});
