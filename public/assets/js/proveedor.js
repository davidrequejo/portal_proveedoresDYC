...
function ver_estados_docs_proveedor(idpersona, id, nombre_razonsocial, email) {
    
  idpersona_tipo = idpersona;
  idtipoestandarproveedor_tipo = id;
  ...
  $.getJSON(`${BASE_URL}/proveedor/ver_listar_tipos_estandar_docs`,{  idtipoestandar: id , idpersona: idpersona}, function (e) {
    if (e.status == true) {
      ...
      e.data.forEach(r => {
          ...
          let estadoHtml = '';
          const isPendiente = (r.estado_revision === null);
        ...
        $(".tbl_lista_documentos").append(`
          <tr>
            ...
            <td class="py-1 text-center" style="cursor:pointer">
                ${r.archivo
                    ? `<a class="text-muted"
                         onclick="ver_documento_proveedor('${r.archivo}','${r.detalle}')">
            ...
            <td class="py-1 text-center" >
              ${isPendiente
                  ...
                  : `<a class="btn btn-info btn-sm"
                      onclick="actualizar_estado_documento(${r.iddocsproveedortipoestandar}, ${r.idpersona},'${r.detalle ?? ''}')">
                      <i class="fas fa-pencil-alt"></i> Editar
                    </a>`
              }
            </td>
  ...
  $.ajax({
    ...
    success: function (e) {
      try {        
        if (e.status == true) {          
          tabla_principal_cargar(); 
          ver_estados_docs_proveedor(idpersona_tipo, idtipoestandarproveedor_tipo, nombre_razonsocial_tipo);
